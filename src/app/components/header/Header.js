    ...
    <header>
      <div className="container">
        <div className="header-wrapper">
          <h1 className="hidden-xs visible-lg"><span className="symbol-lg">&#9992;</span> Flight Search Engine</h1>
          <h1 className="visible-xs hidden-lg"><span className="symbol">&#9992;</span> FSE</h1>
